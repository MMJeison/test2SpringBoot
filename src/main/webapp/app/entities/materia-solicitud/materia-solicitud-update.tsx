  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="test2SpringBootApp.materiaSolicitud.home.createOrEditLabel" data-cy="MateriaSolicitudCreateUpdateHeading">
            <Translate contentKey="test2SpringBootApp.materiaSolicitud.home.createOrEditLabel">Create or edit a MateriaSolicitud</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('test2SpringBootApp.materiaSolicitud.idSolicitud')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.materiaSolicitud.codigoMateria')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.materiaSolicitud.idSemestrePasada')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.materiaSolicitud.notaDefinitiva')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.materiaSolicitud.cedulaEstufiante')}
              ...
              <ValidatedField
                ...
                name="materia"
                data-cy="materia"
                label={translate('test2SpringBootApp.materiaSolicitud.materia')}
                type="select"
              >
                <option value="" key="0" />
                {materias
              ...
              <ValidatedField
                ...
                label={translate('test2SpringBootApp.materiaSolicitud.solicitudHomologacion')}
                type="select"
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="estudiante"
                data-cy="estudiante"
                label={translate('test2SpringBootApp.materiaSolicitud.estudiante')}
                type="select"
              >
                <option value="" key="0" />
                {estudiantes
