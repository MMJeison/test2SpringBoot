...
export const MateriaSolicitudDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="test2SpringBootApp.materiaSolicitud.delete.question">
        <Translate contentKey="test2SpringBootApp.materiaSolicitud.delete.question" interpolate={{ id: materiaSolicitudEntity.id }}>
          Are you sure you want to delete this MateriaSolicitud?
        </Translate>
      </ModalBody>
      <ModalFooter>
