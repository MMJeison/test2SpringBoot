  ...
  return (
    <div>
      <h2 id="materia-solicitud-heading" data-cy="MateriaSolicitudHeading">
        <Translate contentKey="test2SpringBootApp.materiaSolicitud.home.title">Materia Solicituds</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="test2SpringBootApp.materiaSolicitud.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/materia-solicitud/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="test2SpringBootApp.materiaSolicitud.home.createLabel">Create new Materia Solicitud</Translate>
          </Link>
        </div>
      </h2>
        ...
        {materiaSolicitudList && materiaSolicitudList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="test2SpringBootApp.materiaSolicitud.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.materiaSolicitud.idSolicitud">Id Solicitud</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.materiaSolicitud.codigoMateria">Codigo Materia</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.materiaSolicitud.idSemestrePasada">Id Semestre Pasada</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.materiaSolicitud.notaDefinitiva">Nota Definitiva</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.materiaSolicitud.cedulaEstufiante">Cedula Estufiante</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.materiaSolicitud.materia">Materia</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.materiaSolicitud.solicitudHomologacion">Solicitud Homologacion</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.materiaSolicitud.estudiante">Estudiante</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="test2SpringBootApp.materiaSolicitud.home.notFound">No Materia Solicituds found</Translate>
            </div>
          )
        )}
      </div>
