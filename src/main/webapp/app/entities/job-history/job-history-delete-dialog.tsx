...
export const JobHistoryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="test2SpringBootApp.jobHistory.delete.question">
        <Translate contentKey="test2SpringBootApp.jobHistory.delete.question" interpolate={{ id: jobHistoryEntity.id }}>
