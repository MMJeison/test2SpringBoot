  ...
  return (
    <div>
      <h2 id="country-heading" data-cy="CountryHeading">
        <Translate contentKey="test2SpringBootApp.country.home.title">Countries</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="test2SpringBootApp.country.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/country/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="test2SpringBootApp.country.home.createLabel">Create new Country</Translate>
          </Link>
        </div>
      </h2>
        ...
        {countryList && countryList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="test2SpringBootApp.country.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.country.countryName">Country Name</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.country.region">Region</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="test2SpringBootApp.country.home.notFound">No Countries found</Translate>
            </div>
          )
        )}
      </div>
