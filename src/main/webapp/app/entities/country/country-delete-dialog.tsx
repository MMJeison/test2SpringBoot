...
export const CountryDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="test2SpringBootApp.country.delete.question">
        <Translate contentKey="test2SpringBootApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
