    ...
    <Row>
      <Col md="8">
        <h2 data-cy="jobDetailsHeading">
          <Translate contentKey="test2SpringBootApp.job.detail.title">Job</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="jobTitle">
              <Translate contentKey="test2SpringBootApp.job.jobTitle">Job Title</Translate>
            </span>
          </dt>
          <dd>{jobEntity.jobTitle}</dd>
          <dt>
            <span id="minSalary">
              <Translate contentKey="test2SpringBootApp.job.minSalary">Min Salary</Translate>
            </span>
          </dt>
          <dd>{jobEntity.minSalary}</dd>
          <dt>
            <span id="maxSalary">
              <Translate contentKey="test2SpringBootApp.job.maxSalary">Max Salary</Translate>
            </span>
          </dt>
          <dd>{jobEntity.maxSalary}</dd>
          <dt>
            <Translate contentKey="test2SpringBootApp.job.task">Task</Translate>
          </dt>
          <dd>
            {jobEntity.tasks
          ...
          <dt>
            <Translate contentKey="test2SpringBootApp.job.employee">Employee</Translate>
          </dt>
