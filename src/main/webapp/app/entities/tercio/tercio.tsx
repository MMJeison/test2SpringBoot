  ...
  return (
    <div>
      <h2 id="tercio-heading" data-cy="TercioHeading">
        <Translate contentKey="test2SpringBootApp.tercio.home.title">Tercios</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="test2SpringBootApp.tercio.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/tercio/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="test2SpringBootApp.tercio.home.createLabel">Create new Tercio</Translate>
          </Link>
        </div>
      </h2>
        ...
        {tercioList && tercioList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="test2SpringBootApp.tercio.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.tercio.idTercio">Id Tercio</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.tercio.tercioDescription">Tercio Description</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="test2SpringBootApp.tercio.home.notFound">No Tercios found</Translate>
            </div>
          )
        )}
      </div>
