  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="test2SpringBootApp.tercio.home.createOrEditLabel" data-cy="TercioCreateUpdateHeading">
            <Translate contentKey="test2SpringBootApp.tercio.home.createOrEditLabel">Create or edit a Tercio</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('test2SpringBootApp.tercio.idTercio')}
                id="tercio-idTercio"
                name="idTercio"
                data-cy="idTercio"
                type="text"
              />
              <ValidatedField
                label={translate('test2SpringBootApp.tercio.tercioDescription')}
