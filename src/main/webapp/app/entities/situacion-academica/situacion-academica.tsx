  ...
  return (
    <div>
      <h2 id="situacion-academica-heading" data-cy="SituacionAcademicaHeading">
        <Translate contentKey="test2SpringBootApp.situacionAcademica.home.title">Situacion Academicas</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="test2SpringBootApp.situacionAcademica.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link
          ...
          >
            ...
            &nbsp;
            <Translate contentKey="test2SpringBootApp.situacionAcademica.home.createLabel">Create new Situacion Academica</Translate>
          </Link>
        </div>
      </h2>
        ...
        {situacionAcademicaList && situacionAcademicaList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="test2SpringBootApp.situacionAcademica.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.situacionAcademica.idSituacionAcademica">Id Situacion Academica</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.situacionAcademica.situationAcademica">Situation Academica</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="test2SpringBootApp.situacionAcademica.home.notFound">No Situacion Academicas found</Translate>
            </div>
          )
        )}
      </div>
