  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="test2SpringBootApp.situacionAcademica.home.createOrEditLabel" data-cy="SituacionAcademicaCreateUpdateHeading">
            <Translate contentKey="test2SpringBootApp.situacionAcademica.home.createOrEditLabel">
              Create or edit a SituacionAcademica
            </Translate>
          </h2>
        </Col>
      </Row>
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('test2SpringBootApp.situacionAcademica.idSituacionAcademica')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.situacionAcademica.situationAcademica')}
