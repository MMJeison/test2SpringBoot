...
export const SituacionAcademicaDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="test2SpringBootApp.situacionAcademica.delete.question">
        <Translate contentKey="test2SpringBootApp.situacionAcademica.delete.question" interpolate={{ id: situacionAcademicaEntity.id }}>
