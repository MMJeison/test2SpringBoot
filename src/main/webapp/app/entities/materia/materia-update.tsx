  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="test2SpringBootApp.materia.home.createOrEditLabel" data-cy="MateriaCreateUpdateHeading">
            <Translate contentKey="test2SpringBootApp.materia.home.createOrEditLabel">Create or edit a Materia</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('test2SpringBootApp.materia.codigoMateria')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.materia.nombreMateria')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.materia.creditos')}
                id="materia-creditos"
                name="creditos"
                data-cy="creditos"
                type="text"
