  ...
  return (
    <div>
      <h2 id="materia-heading" data-cy="MateriaHeading">
        <Translate contentKey="test2SpringBootApp.materia.home.title">Materias</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="test2SpringBootApp.materia.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/materia/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="test2SpringBootApp.materia.home.createLabel">Create new Materia</Translate>
          </Link>
        </div>
      </h2>
        ...
        {materiaList && materiaList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="test2SpringBootApp.materia.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.materia.codigoMateria">Codigo Materia</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.materia.nombreMateria">Nombre Materia</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.materia.creditos">Creditos</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="test2SpringBootApp.materia.home.notFound">No Materias found</Translate>
            </div>
          )
        )}
      </div>
