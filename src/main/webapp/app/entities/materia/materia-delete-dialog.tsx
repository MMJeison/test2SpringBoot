...
export const MateriaDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="test2SpringBootApp.materia.delete.question">
        <Translate contentKey="test2SpringBootApp.materia.delete.question" interpolate={{ id: materiaEntity.id }}>
