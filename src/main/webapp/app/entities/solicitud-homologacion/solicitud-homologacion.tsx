  ...
  return (
    <div>
      <h2 id="solicitud-homologacion-heading" data-cy="SolicitudHomologacionHeading">
        <Translate contentKey="test2SpringBootApp.solicitudHomologacion.home.title">Solicitud Homologacions</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="test2SpringBootApp.solicitudHomologacion.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link
          ...
          >
            ...
            &nbsp;
            <Translate contentKey="test2SpringBootApp.solicitudHomologacion.home.createLabel">Create new Solicitud Homologacion</Translate>
          </Link>
        </div>
      </h2>
        ...
        {solicitudHomologacionList && solicitudHomologacionList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="test2SpringBootApp.solicitudHomologacion.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.solicitudHomologacion.idSolicitud">Id Solicitud</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.solicitudHomologacion.stateSolicitud">State Solicitud</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.solicitudHomologacion.codigoPrograma">Codigo Programa</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.solicitudHomologacion.fechaSolicitud">Fecha Solicitud</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.solicitudHomologacion.comentario">Comentario</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.solicitudHomologacion.programaAcademico">Programa Academico</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.solicitudHomologacion.estadoSolicitud">Estado Solicitud</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="test2SpringBootApp.solicitudHomologacion.home.notFound">No Solicitud Homologacions found</Translate>
            </div>
          )
        )}
      </div>
