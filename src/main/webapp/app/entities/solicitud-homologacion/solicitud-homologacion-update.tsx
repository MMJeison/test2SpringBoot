  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="test2SpringBootApp.solicitudHomologacion.home.createOrEditLabel" data-cy="SolicitudHomologacionCreateUpdateHeading">
            <Translate contentKey="test2SpringBootApp.solicitudHomologacion.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('test2SpringBootApp.solicitudHomologacion.idSolicitud')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.solicitudHomologacion.stateSolicitud')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.solicitudHomologacion.codigoPrograma')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.solicitudHomologacion.fechaSolicitud')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.solicitudHomologacion.comentario')}
              ...
              <ValidatedField
                ...
                label={translate('test2SpringBootApp.solicitudHomologacion.programaAcademico')}
                type="select"
              >
                <option value="" key="0" />
                {programaAcademicos
              ...
              <ValidatedField
                ...
                label={translate('test2SpringBootApp.solicitudHomologacion.estadoSolicitud')}
                type="select"
              >
                <option value="" key="0" />
                {estadoSolicituds
