...
export const ProgramaAcademicoDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="test2SpringBootApp.programaAcademico.delete.question">
        <Translate contentKey="test2SpringBootApp.programaAcademico.delete.question" interpolate={{ id: programaAcademicoEntity.id }}>
