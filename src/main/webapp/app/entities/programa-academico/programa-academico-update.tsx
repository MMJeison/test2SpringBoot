  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="test2SpringBootApp.programaAcademico.home.createOrEditLabel" data-cy="ProgramaAcademicoCreateUpdateHeading">
            <Translate contentKey="test2SpringBootApp.programaAcademico.home.createOrEditLabel">
              Create or edit a ProgramaAcademico
            </Translate>
          </h2>
        </Col>
      </Row>
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('test2SpringBootApp.programaAcademico.codigoPrograma')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.programaAcademico.nombrePrograma')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.programaAcademico.duracion')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.programaAcademico.vigencia')}
