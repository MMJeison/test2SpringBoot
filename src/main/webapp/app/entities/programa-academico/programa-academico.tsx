  ...
  return (
    <div>
      <h2 id="programa-academico-heading" data-cy="ProgramaAcademicoHeading">
        <Translate contentKey="test2SpringBootApp.programaAcademico.home.title">Programa Academicos</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="test2SpringBootApp.programaAcademico.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link
          ...
          >
            ...
            &nbsp;
            <Translate contentKey="test2SpringBootApp.programaAcademico.home.createLabel">Create new Programa Academico</Translate>
          </Link>
        </div>
      </h2>
        ...
        {programaAcademicoList && programaAcademicoList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="test2SpringBootApp.programaAcademico.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.programaAcademico.codigoPrograma">Codigo Programa</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.programaAcademico.nombrePrograma">Nombre Programa</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.programaAcademico.duracion">Duracion</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.programaAcademico.vigencia">Vigencia</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="test2SpringBootApp.programaAcademico.home.notFound">No Programa Academicos found</Translate>
            </div>
          )
        )}
      </div>
