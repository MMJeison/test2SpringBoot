  ...
  return (
    <div>
      <h2 id="relacion-heading" data-cy="RelacionHeading">
        <Translate contentKey="test2SpringBootApp.relacion.home.title">Relacions</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="test2SpringBootApp.relacion.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/relacion/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="test2SpringBootApp.relacion.home.createLabel">Create new Relacion</Translate>
          </Link>
        </div>
      </h2>
        ...
        {relacionList && relacionList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="test2SpringBootApp.relacion.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.relacion.codigoMateria">Codigo Materia</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.relacion.codigoMateriaRelacionada">Codigo Materia Relacionada</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.relacion.tipoRelacion">Tipo Relacion</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.relacion.materia">Materia</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="test2SpringBootApp.relacion.home.notFound">No Relacions found</Translate>
            </div>
          )
        )}
      </div>
