...
export const RelacionDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="test2SpringBootApp.relacion.delete.question">
        <Translate contentKey="test2SpringBootApp.relacion.delete.question" interpolate={{ id: relacionEntity.id }}>
