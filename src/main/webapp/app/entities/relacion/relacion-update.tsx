  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="test2SpringBootApp.relacion.home.createOrEditLabel" data-cy="RelacionCreateUpdateHeading">
            <Translate contentKey="test2SpringBootApp.relacion.home.createOrEditLabel">Create or edit a Relacion</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('test2SpringBootApp.relacion.codigoMateria')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.relacion.codigoMateriaRelacionada')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.relacion.tipoRelacion')}
              ...
              <ValidatedField
                ...
                name="materia"
                data-cy="materia"
                label={translate('test2SpringBootApp.relacion.materia')}
                type="select"
              >
                <option value="" key="0" />
                {materias
