  ...
  return (
    <div>
      <h2 id="estado-semestre-heading" data-cy="EstadoSemestreHeading">
        <Translate contentKey="test2SpringBootApp.estadoSemestre.home.title">Estado Semestres</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="test2SpringBootApp.estadoSemestre.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/estado-semestre/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="test2SpringBootApp.estadoSemestre.home.createLabel">Create new Estado Semestre</Translate>
          </Link>
        </div>
      </h2>
        ...
        {estadoSemestreList && estadoSemestreList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="test2SpringBootApp.estadoSemestre.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.estadoSemestre.idEstadoSemestre">Id Estado Semestre</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.estadoSemestre.stateSemestre">State Semestre</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="test2SpringBootApp.estadoSemestre.home.notFound">No Estado Semestres found</Translate>
            </div>
          )
        )}
      </div>
