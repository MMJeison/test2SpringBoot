...
export const EstadoSemestreDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="test2SpringBootApp.estadoSemestre.delete.question">
        <Translate contentKey="test2SpringBootApp.estadoSemestre.delete.question" interpolate={{ id: estadoSemestreEntity.id }}>
