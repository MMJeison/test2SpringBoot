  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="test2SpringBootApp.estadoSemestre.home.createOrEditLabel" data-cy="EstadoSemestreCreateUpdateHeading">
            <Translate contentKey="test2SpringBootApp.estadoSemestre.home.createOrEditLabel">Create or edit a EstadoSemestre</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('test2SpringBootApp.estadoSemestre.idEstadoSemestre')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.estadoSemestre.stateSemestre')}
