...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="test2SpringBootApp.department.delete.question">
        <Translate contentKey="test2SpringBootApp.department.delete.question" interpolate={{ id: departmentEntity.id }}>
