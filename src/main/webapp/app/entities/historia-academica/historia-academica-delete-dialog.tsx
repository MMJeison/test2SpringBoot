...
export const HistoriaAcademicaDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="test2SpringBootApp.historiaAcademica.delete.question">
        <Translate contentKey="test2SpringBootApp.historiaAcademica.delete.question" interpolate={{ id: historiaAcademicaEntity.id }}>
          Are you sure you want to delete this HistoriaAcademica?
        </Translate>
      </ModalBody>
      <ModalFooter>
