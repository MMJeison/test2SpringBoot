  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="test2SpringBootApp.historiaAcademica.home.createOrEditLabel" data-cy="HistoriaAcademicaCreateUpdateHeading">
            <Translate contentKey="test2SpringBootApp.historiaAcademica.home.createOrEditLabel">
              Create or edit a HistoriaAcademica
            </Translate>
          </h2>
        </Col>
      </Row>
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('test2SpringBootApp.historiaAcademica.idHistoriaAcademica')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.historiaAcademica.cedulaEstudiante')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.historiaAcademica.idSemestre')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.historiaAcademica.codigoPrograma')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.historiaAcademica.promedioAcomulado')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.historiaAcademica.promedioSemestre')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.historiaAcademica.idTercio')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.historiaAcademica.situationAcademica')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.historiaAcademica.stateSemestre')}
              ...
              <ValidatedField
                ...
                name="estudiante"
                data-cy="estudiante"
                label={translate('test2SpringBootApp.historiaAcademica.estudiante')}
                type="select"
              >
                <option value="" key="0" />
                {estudiantes
              ...
              <ValidatedField
                ...
                name="semestre"
                data-cy="semestre"
                label={translate('test2SpringBootApp.historiaAcademica.semestre')}
                type="select"
              >
                <option value="" key="0" />
                {semestres
              ...
              <ValidatedField
                ...
                label={translate('test2SpringBootApp.historiaAcademica.situacionAcademica')}
                type="select"
              >
                <option value="" key="0" />
                {situacionAcademicas
              ...
              <ValidatedField
                ...
                name="tercio"
                data-cy="tercio"
                label={translate('test2SpringBootApp.historiaAcademica.tercio')}
                type="select"
              >
                <option value="" key="0" />
                {tercios
              ...
              <ValidatedField
                ...
                label={translate('test2SpringBootApp.historiaAcademica.estadoSemestre')}
                type="select"
              >
                <option value="" key="0" />
                {estadoSemestres
