...
export const LocationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="test2SpringBootApp.location.delete.question">
        <Translate contentKey="test2SpringBootApp.location.delete.question" interpolate={{ id: locationEntity.id }}>
