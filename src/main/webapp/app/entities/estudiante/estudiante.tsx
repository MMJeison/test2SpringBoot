  ...
  return (
    <div>
      <h2 id="estudiante-heading" data-cy="EstudianteHeading">
        <Translate contentKey="test2SpringBootApp.estudiante.home.title">Estudiantes</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="test2SpringBootApp.estudiante.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/estudiante/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="test2SpringBootApp.estudiante.home.createLabel">Create new Estudiante</Translate>
          </Link>
        </div>
      </h2>
        ...
        {estudianteList && estudianteList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="test2SpringBootApp.estudiante.id">ID</Translate>
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="test2SpringBootApp.estudiante.home.notFound">No Estudiantes found</Translate>
            </div>
          )
        )}
      </div>
