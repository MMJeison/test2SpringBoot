  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="test2SpringBootApp.estudiante.home.createOrEditLabel" data-cy="EstudianteCreateUpdateHeading">
            <Translate contentKey="test2SpringBootApp.estudiante.home.createOrEditLabel">Create or edit a Estudiante</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('test2SpringBootApp.estudiante.cedula')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.estudiante.nombre')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.estudiante.apellido')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.estudiante.correoInstitucional')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.estudiante.correoPersonal')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.estudiante.celular')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.estudiante.estrato')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.estudiante.fechaIngreso')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.estudiante.version')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.estudiante.codigoPrograma')}
              ...
              <ValidatedField
                ...
                label={translate('test2SpringBootApp.estudiante.programaAcademico')}
                type="select"
              >
                <option value="" key="0" />
                {programaAcademicos
              ...
              <ValidatedField
                ...
                label={translate('test2SpringBootApp.estudiante.planEstudios')}
                type="select"
              >
                <option value="" key="0" />
                {planEstudios
