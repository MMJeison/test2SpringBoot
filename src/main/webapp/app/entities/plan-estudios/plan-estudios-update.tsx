  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="test2SpringBootApp.planEstudios.home.createOrEditLabel" data-cy="PlanEstudiosCreateUpdateHeading">
            <Translate contentKey="test2SpringBootApp.planEstudios.home.createOrEditLabel">Create or edit a PlanEstudios</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('test2SpringBootApp.planEstudios.version')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.planEstudios.codigoPrograma')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.planEstudios.fechaAprobacion')}
              ...
              <ValidatedField
                ...
                label={translate('test2SpringBootApp.planEstudios.programaAcademico')}
                type="select"
              >
                <option value="" key="0" />
                {programaAcademicos
