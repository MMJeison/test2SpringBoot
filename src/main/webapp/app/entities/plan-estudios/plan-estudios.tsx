  ...
  return (
    <div>
      <h2 id="plan-estudios-heading" data-cy="PlanEstudiosHeading">
        <Translate contentKey="test2SpringBootApp.planEstudios.home.title">Plan Estudios</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="test2SpringBootApp.planEstudios.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/plan-estudios/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="test2SpringBootApp.planEstudios.home.createLabel">Create new Plan Estudios</Translate>
          </Link>
        </div>
      </h2>
        ...
        {planEstudiosList && planEstudiosList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="test2SpringBootApp.planEstudios.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.planEstudios.version">Version</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.planEstudios.codigoPrograma">Codigo Programa</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.planEstudios.fechaAprobacion">Fecha Aprobacion</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.planEstudios.programaAcademico">Programa Academico</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="test2SpringBootApp.planEstudios.home.notFound">No Plan Estudios found</Translate>
            </div>
          )
        )}
      </div>
