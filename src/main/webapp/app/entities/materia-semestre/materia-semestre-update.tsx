  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="test2SpringBootApp.materiaSemestre.home.createOrEditLabel" data-cy="MateriaSemestreCreateUpdateHeading">
            <Translate contentKey="test2SpringBootApp.materiaSemestre.home.createOrEditLabel">Create or edit a MateriaSemestre</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('test2SpringBootApp.materiaSemestre.idMateriaSemestre')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.materiaSemestre.cedulaEstudiante')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.materiaSemestre.idSemestre')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.materiaSemestre.codigoMateria')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.materiaSemestre.notaDefinitiva')}
              ...
              <ValidatedField
                ...
                name="materia"
                data-cy="materia"
                label={translate('test2SpringBootApp.materiaSemestre.materia')}
                type="select"
              >
                <option value="" key="0" />
                {materias
              ...
              <ValidatedField
                ...
                name="estudiante"
                data-cy="estudiante"
                label={translate('test2SpringBootApp.materiaSemestre.estudiante')}
                type="select"
              >
                <option value="" key="0" />
                {estudiantes
              ...
              <ValidatedField
                ...
                name="semestre"
                data-cy="semestre"
                label={translate('test2SpringBootApp.materiaSemestre.semestre')}
                type="select"
              >
                <option value="" key="0" />
                {semestres
