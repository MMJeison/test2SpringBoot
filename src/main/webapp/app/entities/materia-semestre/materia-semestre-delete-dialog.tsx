...
export const MateriaSemestreDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="test2SpringBootApp.materiaSemestre.delete.question">
        <Translate contentKey="test2SpringBootApp.materiaSemestre.delete.question" interpolate={{ id: materiaSemestreEntity.id }}>
