  ...
  return (
    <div>
      <h2 id="materia-semestre-heading" data-cy="MateriaSemestreHeading">
        <Translate contentKey="test2SpringBootApp.materiaSemestre.home.title">Materia Semestres</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="test2SpringBootApp.materiaSemestre.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/materia-semestre/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="test2SpringBootApp.materiaSemestre.home.createLabel">Create new Materia Semestre</Translate>
          </Link>
        </div>
      </h2>
        ...
        {materiaSemestreList && materiaSemestreList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="test2SpringBootApp.materiaSemestre.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.materiaSemestre.idMateriaSemestre">Id Materia Semestre</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.materiaSemestre.cedulaEstudiante">Cedula Estudiante</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.materiaSemestre.idSemestre">Id Semestre</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.materiaSemestre.codigoMateria">Codigo Materia</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.materiaSemestre.notaDefinitiva">Nota Definitiva</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.materiaSemestre.materia">Materia</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.materiaSemestre.estudiante">Estudiante</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.materiaSemestre.semestre">Semestre</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="test2SpringBootApp.materiaSemestre.home.notFound">No Materia Semestres found</Translate>
            </div>
          )
        )}
      </div>
