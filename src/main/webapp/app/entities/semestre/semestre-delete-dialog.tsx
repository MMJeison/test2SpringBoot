...
export const SemestreDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="test2SpringBootApp.semestre.delete.question">
        <Translate contentKey="test2SpringBootApp.semestre.delete.question" interpolate={{ id: semestreEntity.id }}>
