  ...
  return (
    <div>
      <h2 id="semestre-heading" data-cy="SemestreHeading">
        <Translate contentKey="test2SpringBootApp.semestre.home.title">Semestres</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="test2SpringBootApp.semestre.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/semestre/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="test2SpringBootApp.semestre.home.createLabel">Create new Semestre</Translate>
          </Link>
        </div>
      </h2>
        ...
        {semestreList && semestreList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="test2SpringBootApp.semestre.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.semestre.idSemestre">Id Semestre</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.semestre.fechaInicio">Fecha Inicio</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.semestre.fechaTerminacion">Fecha Terminacion</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.semestre.typeSemestre">Type Semestre</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.semestre.stateSemestre">State Semestre</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.semestre.tipoSemestre">Tipo Semestre</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.semestre.estadoSemestre">Estado Semestre</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="test2SpringBootApp.semestre.home.notFound">No Semestres found</Translate>
            </div>
          )
        )}
      </div>
