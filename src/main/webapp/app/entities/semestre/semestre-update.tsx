  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="test2SpringBootApp.semestre.home.createOrEditLabel" data-cy="SemestreCreateUpdateHeading">
            <Translate contentKey="test2SpringBootApp.semestre.home.createOrEditLabel">Create or edit a Semestre</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('test2SpringBootApp.semestre.idSemestre')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.semestre.fechaInicio')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.semestre.fechaTerminacion')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.semestre.typeSemestre')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.semestre.stateSemestre')}
              ...
              <ValidatedField
                ...
                label={translate('test2SpringBootApp.semestre.tipoSemestre')}
                type="select"
              >
                <option value="" key="0" />
                {tipoSemestres
              ...
              <ValidatedField
                ...
                label={translate('test2SpringBootApp.semestre.estadoSemestre')}
                type="select"
              >
                <option value="" key="0" />
                {estadoSemestres
