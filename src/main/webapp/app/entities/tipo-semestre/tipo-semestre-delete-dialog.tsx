...
export const TipoSemestreDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="test2SpringBootApp.tipoSemestre.delete.question">
        <Translate contentKey="test2SpringBootApp.tipoSemestre.delete.question" interpolate={{ id: tipoSemestreEntity.id }}>
