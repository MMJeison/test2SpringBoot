  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="test2SpringBootApp.tipoSemestre.home.createOrEditLabel" data-cy="TipoSemestreCreateUpdateHeading">
            <Translate contentKey="test2SpringBootApp.tipoSemestre.home.createOrEditLabel">Create or edit a TipoSemestre</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('test2SpringBootApp.tipoSemestre.idTipoSemestre')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.tipoSemestre.typeSemestre')}
