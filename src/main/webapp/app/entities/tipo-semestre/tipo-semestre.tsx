  ...
  return (
    <div>
      <h2 id="tipo-semestre-heading" data-cy="TipoSemestreHeading">
        <Translate contentKey="test2SpringBootApp.tipoSemestre.home.title">Tipo Semestres</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="test2SpringBootApp.tipoSemestre.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/tipo-semestre/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="test2SpringBootApp.tipoSemestre.home.createLabel">Create new Tipo Semestre</Translate>
          </Link>
        </div>
      </h2>
        ...
        {tipoSemestreList && tipoSemestreList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="test2SpringBootApp.tipoSemestre.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.tipoSemestre.idTipoSemestre">Id Tipo Semestre</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.tipoSemestre.typeSemestre">Type Semestre</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="test2SpringBootApp.tipoSemestre.home.notFound">No Tipo Semestres found</Translate>
            </div>
          )
        )}
      </div>
