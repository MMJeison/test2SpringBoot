...
export const EmployeeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="test2SpringBootApp.employee.delete.question">
        <Translate contentKey="test2SpringBootApp.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
