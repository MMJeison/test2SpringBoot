...
export const EstadoSolicitudDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="test2SpringBootApp.estadoSolicitud.delete.question">
        <Translate contentKey="test2SpringBootApp.estadoSolicitud.delete.question" interpolate={{ id: estadoSolicitudEntity.id }}>
