  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="test2SpringBootApp.estadoSolicitud.home.createOrEditLabel" data-cy="EstadoSolicitudCreateUpdateHeading">
            <Translate contentKey="test2SpringBootApp.estadoSolicitud.home.createOrEditLabel">Create or edit a EstadoSolicitud</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('test2SpringBootApp.estadoSolicitud.idEstadoSolicitud')}
              ...
              />
              <ValidatedField
                label={translate('test2SpringBootApp.estadoSolicitud.stateSolicitud')}
