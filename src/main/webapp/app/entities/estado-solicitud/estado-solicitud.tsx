  ...
  return (
    <div>
      <h2 id="estado-solicitud-heading" data-cy="EstadoSolicitudHeading">
        <Translate contentKey="test2SpringBootApp.estadoSolicitud.home.title">Estado Solicituds</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="test2SpringBootApp.estadoSolicitud.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/estado-solicitud/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            ...
            &nbsp;
            <Translate contentKey="test2SpringBootApp.estadoSolicitud.home.createLabel">Create new Estado Solicitud</Translate>
          </Link>
        </div>
      </h2>
        ...
        {estadoSolicitudList && estadoSolicitudList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="test2SpringBootApp.estadoSolicitud.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.estadoSolicitud.idEstadoSolicitud">Id Estado Solicitud</Translate>
                </th>
                <th>
                  <Translate contentKey="test2SpringBootApp.estadoSolicitud.stateSolicitud">State Solicitud</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="test2SpringBootApp.estadoSolicitud.home.notFound">No Estado Solicituds found</Translate>
            </div>
          )
        )}
      </div>
